...
return {
  ...
  parse_snippet({ trig = "floor", name = "floor" }, "\\floor{$1}$0"),
  parse_snippet({ trig = "ceil", name = "ceil" }, "\\ceil{$1}$0"),
  ...
  parse_snippet({ trig = "norm", name = "norm" }, "\\norm{$1}$0"),
  ...
  parse_snippet({ trig = "FF", name = "fency F" }, "\\F"),
  parse_snippet({ trig = "BB", name = "fency B (Borel)" }, "\\B"),
  parse_snippet({ trig = "OO", name = "emptyset" }, "\\O"),
  parse_snippet({ trig = "RR", name = "R" }, "\\R"),
  parse_snippet({ trig = "QQ", name = "Q" }, "\\Q"),
  parse_snippet({ trig = "ZZ", name = "Z" }, "\\Z"),
  ...
  parse_snippet({ trig = "toprob", name = "converge to probability" }, "\\toprob"),
  parse_snippet({ trig = "todist", name = "converge to distribution" }, "\\todist"),
  parse_snippet({ trig = "toas", name = "converge to Probability" }, "\\toas"),
  ...
  parse_snippet({ trig = "iid", name = "iid ~" }, "\\iid"),
